...
- **Kapanış:** 2026-09-24 — **TB-014: Harf harf okunan kısaltmalar yanlış ek alıyor.**
  ...
  - **Ders:** Beklenen değer bile kaynaktan okunmalı. Kaydı açarken `SGK'da`yı gündelik konuşmadan yazdım; TDK'nın kendi kısaltması (`TDK'den`) tersini gösteriyordu. Ayrıca bir sorunun yanındaki kod okunmalı: "-aş" hatası TB-014'ün aradığı şey değildi ama aynı işlevin aynı parçasıydı ve müşteriye giden mesajı bozuyordu.
